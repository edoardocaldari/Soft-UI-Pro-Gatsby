    ...
    <div className={styles['container']}>
      ...
      <section className={styles['container05']}>
        <div className={styles['container06']}>
          <h1
            className={` ${styles['text05']} ${projectStyles['heading-one']} `}
          >
        ...
        <div className={styles['container12']}>
          <div className={styles['container13']}>
            <div className={styles['container14']}>
              <h2
                className={` ${styles['text23']} ${projectStyles['heading-one']} `}
              >
                Work with us
              </h2>
      ...
      <section className={styles['contaier']}>
        <div className={styles['container30']}>
          ...
          <h2
            className={` ${styles['text30']} ${projectStyles['heading-two']} `}
          >
            <span className={styles['text31']}>Beware The Components</span>
          </h2>
          <h3
            className={` ${styles['text32']} ${projectStyles['heading-two']} `}
          >
        ...
        <div className={styles['container32']}>
          <div className={styles['container33']}>
            ...
            <div className={styles['container35']}>
              ...
              <h1
                className={` ${styles['text36']} ${projectStyles['heading-one']} `}
              >
                Search and Discover!
              </h1>
        ...
        <div className={styles['container37']}>
          ...
          <div className={styles['container39']}>
            ...
            <div className={styles['container41']}>
              ...
              <h1
                className={` ${styles['text40']} ${projectStyles['heading-one']} `}
              >
                Talk and Meet!
              </h1>
